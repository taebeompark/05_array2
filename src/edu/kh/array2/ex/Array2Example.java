...
public class Array2Example {
	...
	public void ex1() {
		...
		arr = new int[2][3];
		//heap 영역에 int 2차원 배열2행 3열 공간을 할당
		...
		*/
		...
		//2) 2중for문을이용한 초기화
		int num=10; //배열요소 초기화에 사용할 변수
		
		//*배열 길이
		//-> 배열명.length 는 변수가 직접참조하고잇는 배열의 길이반환
		...
		//Arrays.toString(배열명):참조하고있는 1차원 배열 값을문자열로 변환
